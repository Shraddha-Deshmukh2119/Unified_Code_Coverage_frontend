      ...
      <div className="ai-insights-container">
        ...
        <div style={{ 
          ...
          {[
            ...
            { id: "explorer", label: "AI Issue Explorer", icon: <Search size={18} /> },
            { id: "complexity", label: "Module Complexity", icon: <Clock size={18} /> }
          ].map(tab => (
            <button
              key={tab.id}
              onClick={() => {
        ...
        <div style={{ display: activeTab === "overview" ? "flex" : "none", flexDirection: "column", gap: "16px", animation: "fadeIn 0.3s ease-out" }}>
          <h2 style={{ fontSize: "18px", fontWeight: 700, margin: 0 }}>AI Insights {"&"} Code Recommendations</h2>
          ...
          <div className="kpi-grid">
            <div className="kpi-card" style={{ borderTop: "4px solid var(--google-blue-600)", cursor: "pointer" }} onClick={() => { setActiveTab("explorer"); setSeverityFilter("All"); setTypeFilter("All"); }}>
              ...
              <span className="kpi-lbl">Total AI Issues</span>
            </div>
